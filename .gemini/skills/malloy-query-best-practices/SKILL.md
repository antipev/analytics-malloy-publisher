...
## Discovery Protocol for Templates (Named Queries & Views)
If the user asks to find templates, pre-configured queries, or available views, execute the following chain of actions:
